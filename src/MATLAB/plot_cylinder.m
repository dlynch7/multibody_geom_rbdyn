...
%
% Description:
%   This function plots a cylinder in the configuration specified by Twb,
%   a 4x4 homogeneous transformation matrix, i.e., an element of SE(3).
%
% Inputs:
%   ax: a handle to the axes on which to plot the cylinder
%   Twb: configuration of the cylinder's CoM frame {b} relative to the
...
function plot_cylinder(ax,Twb,body_params)
